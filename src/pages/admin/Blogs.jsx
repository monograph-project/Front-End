  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? "border-primary shadow-[0_0_0_1px_rgba(10,10,10,0.08)] dark:border-dark-primary"
...
function Blogs() {
  ...
  const topSummaryCards = [
    {
      label: "Total blogs",
      value: counts.total,
      hint: "All drafts, pending, accepted, and published articles.",
      icon: BookText,
    ...
    },
    {
      ...
      hint: "Submissions that still need an admin decision.",
      icon: FileClock,
    ...
    },
    {
      ...
      hint: "Approved and ready for scheduling or publish.",
      icon: CircleCheckBig,
    ...
    },
    {
      ...
      hint: "Visible to users right now.",
      icon: Send,
  ...
  return (
    <div className="flex min-h-screen flex-1 overflow-y-auto bg-shell  dark:bg-dark-shell p-2">
      <div className="mx-auto w-full max-w-7xl space-y-6">
        <section className="overflow-hidden rounded-md border border-default bg-card dark:border-dark-default dark:bg-dark-card">
            ...
            <div className="relative flex flex-col gap-7 xl:flex-row xl:items-start xl:justify-between">
              <div className="max-w-3xl">
                ...
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-primary dark:text-dark-primary md:text-5xl">
                  Publishing desk for writer submissions
                </h1>
                <p className="mt-4 max-w-2xl text-base leading-7 text-secondary dark:text-dark-secondary">
                  Moderate every submitted article from one workspace. Pending
                  stories stay hidden until an admin approves them, then you can
                  publish immediately or hold them in accepted state.
                </p>
              </div>
              ...
              <div className="grid gap-3 sm:grid-cols-3 xl:min-w-105">
                <div className="rounded-md border border-dashed border-default bg-shell p-4 dark:border-dark-default dark:bg-dark-shell">
                  ...
                  <p className="mt-2 text-sm text-secondary dark:text-dark-secondary">
                    Highlighted for priority visibility.
                  </p>
                </div>
                <div className="rounded-md border border-dashed border-default bg-shell p-4 dark:border-dark-default dark:bg-dark-shell">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted dark:text-dark-muted">
                  ...
                  <p className="mt-2 text-sm text-secondary dark:text-dark-secondary">
                    Portion of all articles now public.
                  </p>
                </div>
                <div className="rounded-md border border-dashed border-default bg-shell p-4 dark:border-dark-default dark:bg-dark-shell">
        ...
        <section className="rounded-md border border-default bg-card dark:border-dark-default dark:bg-dark-card">
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-base text-secondary dark:text-dark-secondary">
                    Browse submissions, filter by moderation state, and review
                    each article before it reaches readers.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm">
                  <span className="text-muted dark:text-dark-muted">
                    Displaying {filteredBlogs.length} of {counts.total} blogs
                  </span>
                  {hasFilters && (
                    <button
                      type="button"
          ...
          <div className="px-6 py-6 md:px-8">
            ...
            {!filteredBlogs.length && (
              <div className="rounded-[28px] border border-dashed border-default px-6 py-14 text-center dark:border-dark-default">
                <p className="text-lg font-semibold text-primary dark:text-dark-primary">
                  No blogs match this filter
                </p>
                <p className="mt-2 text-sm text-secondary dark:text-dark-secondary">
                  Try another status, reset the search, or switch the sort
                  order.
                </p>
              </div>
            )}
