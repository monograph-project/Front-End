    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="bg-text-400/20  backdrop-blur-[1px]  bg-black/15 dark:bg-gray-950/80   h-screen  mx-auto   fixed inset-0 z-999 flex justify-center items-center  cursor-pointer"
        >
          <motion.div
