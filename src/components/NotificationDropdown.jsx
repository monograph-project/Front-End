    ...
    <Dropdown className="w-85 sm:w-95 overflow-hidden" ref={ref}>
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-3 border-b border-default dark:border-dark-default">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 flex cursor-pointer hover:text-accent dark:hover:text-accent-dark items-center justify-center rounded-lg hover:bg-hover dark:hover:bg-dark-hover text-muted dark:text-dark-muted"
          >
            <Icon
          ...
          filtered.map((n) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0 group">
                <div className="flex items-start justify-between gap-2 group-hover:text-white">
                  <p
                    className={`text-xs font-semibold group-hover:text-white leading-snug truncate ${n.unread ? "text-primary dark:text-dark-primary" : "text-secondary dark:text-dark-secondary"}`}
                  >
                    {n.title}
                  </p>
                  <span className="text-[10px] text-muted dark:text-dark-muted shrink-0 mt-0.5">
                    {n.time}
                  </span>
                </div>
