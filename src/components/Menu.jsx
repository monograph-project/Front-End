...
export default function Menu() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#010409]">
      <div
        className="flex flex-col w-[200px] rounded-md overflow-hidden"
      ...
      >
        {menuItems.map((item, index) => (
          <button
            ...
            className={`
              relative flex items-center gap-2 px-3 py-[10px] text-sm text-white border-none cursor-pointer rounded-[4px] transition-colors duration-150
              ${
                active === index
                  ? "bg-[#1A1F24]"
                  : "bg-transparent hover:bg-[#21262C]"
              }
            `}
          >
            {/* Left accent bar */}
